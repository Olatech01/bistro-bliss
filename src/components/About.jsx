            ...
            <div className='w-full flex'>
                ...
                <div className='absolute flex flex-col gap-3.5 rounded-2xl justify-center px-5 left-90 top-440 right-0 bg-[#474747] w-102.75 h-80.25'>
                    ...
                    <div className='flex items-center gap-2.5 text-white'>
                        <Phone />
                        <h2 className='text-[16px] font-medium'>(414) 857 - 0107</h2>
                    </div>
                    <div className='flex items-center gap-2.5 text-white'>
                        <Mail />
                        <h2 className='text-[16px] font-medium'>happytummy@restaurant.com</h2>
                    </div>
                    <div className='flex items-center gap-2.5 text-white'>
                        <Locate />
                        <h2 className='text-[16px] font-medium'>837 W. Marshall Lane Marshalltown, IA 50158, Los Angeles</h2>
                    </div>
                </div>
            </div>
            <div className='w-full space-y-4'>
                <h2 className='text-[55px] font-medium leading-15 w-139.25'>
                    We provide healthy food for your family.
                </h2>
                <p className='text-[18px] font-medium w-139.25'>
                ...
                <p className='text-[16px] font-normal w-139.25'>
